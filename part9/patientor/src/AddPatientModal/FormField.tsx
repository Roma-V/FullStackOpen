...
type HealthRatingSelectFieldProps = {
  name: string;
  label: string;
...
export const HealthRatingSelectField: React.FC<HealthRatingSelectFieldProps> = ({
  name,
  label,
  options
}: HealthRatingSelectFieldProps) => (
  <Form.Field>
    <label>{label}</label>
    <Field as="select" name={name} className="ui dropdown">
      {options.map(option => (
...
export const EntryTypeSelectField: React.FC<EntryTypeSelectFieldProps> = ({
  name,
  label,
  options

...
const patientParser_1 = require("../utils/patientParser");
const patients = [
    {
...
const addPatient = (patient) => {
    const newPatient = Object.assign({ id: uuid_1.v4() }, patientParser_1.toNewPatient(patient));
